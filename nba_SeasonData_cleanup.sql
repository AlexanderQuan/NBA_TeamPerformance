...
--Replace team names to their abbreviation to keep data consistent throughout the tables
 ...
 INTO dbo.all_SeasonStandings_Final
 FROM ranking 
...
ALTER TABLE all_SeasonStandings_Final
ADD win_PCT decimal(8,3)

/*acquired win percenteage*/
UPDATE all_SeasonStandings_Final
...
SELECT all_SeasonAVG_final.TEAM_NAME,
		all_SeasonAVG_final.SEASON,
		Total_Games,
		Win,
		Lose,
		win_PCT,
		...
		AVG_STL,
		AVG_TO
INTO nba_seasonData_Final
FROM all_SeasonAVG_final
INNER JOIN all_SeasonStandings_Final ON
all_SeasonAVG_final.TEAM_NAME = all_SeasonStandings_Final.Team_name and all_SeasonStandings_final.SEASON = all_SeasonAVG_final.SEASON
ORDER BY all_seasonstandings_Final.season desc
